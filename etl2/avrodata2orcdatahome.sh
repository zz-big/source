...
jar_file=${ETL_BASE_PATH}/jar/${JAR_NAME1}
...
#log输入路径
input_path=${TABLE_HDFS_BASE_PATH}/${ETL_AVRO_TABLE_NAME}/${month}/${day}
task_id=${run_day}_zz
...
hadoop_cmd="hadoop jar ${jar_file} etlorchome -Dmymr.task.id=${task_id} -Dmymr.task.input=${input_path}"
