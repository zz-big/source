...
sql="use ${db_name};alter table ${orc_name1} add IF NOT EXISTS partition(month='${month}',day='${day}'
) location '${month}/${day}';"
...
sql="use ${db_name};alter table ${orc_name2} add IF NOT EXISTS partition(month='${month}',day='${day}'
) location '${month}/${day}';"
